...
output_file="clickstream-feed-generated.tsv"
rm $output_file

#filename="../data/raw/filtered-omniture-raw.tsv"
filename="/Users/msoomar/Dev/GitHub_Projects/muki-clickstream/data/raw/filtered-omniture-raw.tsv"
x=0
y=`cat $filename | wc -l`
...
#   For Streaming data to NiFi and SAM - for streaming analytics
    echo $print1"|"$url"|"$isPurchased"|"$isError"|"$print2
